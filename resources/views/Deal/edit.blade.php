  ...
  <div class="row">
      <div class="col-lg-6">
          ...
          <ol class="breadcrumb">
              ...
              <li class="active">
                  <i class="fa fa-file"></i> Editar datos del Negocio {{$deal->nombre}}
              </li>
          </ol>
        </div>
  </div>
              ...
              <div class="container-fluid">
                  <div class="row">
                      <div class="col-lg-12">
                        ...
                        <h1>Editar datos del negocio</h1>

                        <form method="POST" action="{{ route('deal.update',$deal) }}"  role="form">
                            {{ csrf_field() }}
                            <input name="_method" type="hidden" value="PATCH">
                            <!-- Name -->
                            <div class="form-group">
                              <label>Nombre </label>
                              <input type="text" class="form-control" name="nombre" id="nombre"  placeholder="Nombre del Negocio" value="{{$deal->nombre}}">
                            </div>
                            <!-- Direccion -->
                              <div class="form-group">
                                  <label>Dirección </label>
                                  <textarea name="direccion" id="direccion" rows="5" cols="80" class="form-control" placeholder="Dirección del Negocio">{{$deal->direccion}}</textarea>
                              </div>

                            <!-- Telefono -->
                                <div class="form-group">
                                    <label>Teléfono </label>
                                    <input type="text" class="form-control" name="telefono" id="telefono"  placeholder="Telefono del Negocio" value="{{$deal->telefono}}">
                                </div>
                            <!-- Email -->
                                  <div class="form-group">
                                      <label>Correo Electrónico </label>
                                      <input type="email" class="form-control" name="email" id="email"  placeholder="Email del Negocio" value="{{$deal->email}}">
                                  </div>
                  ...
                  <!-- /.row -->
                  <!-- Adjustment -->
                   @include('Deal.partials.adjustment')
              </div>
              <!-- /.container-fluid -->
